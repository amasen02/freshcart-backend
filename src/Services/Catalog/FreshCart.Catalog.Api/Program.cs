...
webApplicationBuilder.Services.AddCatalogServices(webApplicationBuilder.Configuration);
...
webApplicationBuilder.Services.AddAuthorization(authorizationOptions =>
    authorizationOptions.AddPolicy(AuthorizationPolicies.CatalogManager, policyBuilder =>
        policyBuilder
            .RequireAuthenticatedUser()
            .RequireRole(AuthorizationPolicies.AdministratorRoleName, AuthorizationPolicies.ManagerRoleName)));
