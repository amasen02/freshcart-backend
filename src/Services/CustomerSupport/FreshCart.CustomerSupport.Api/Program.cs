...
using FreshCart.CustomerSupport.Api;
...
webApplicationBuilder.Services.AddCustomerSupportServices(webApplicationBuilder.Configuration);
...
webApplicationBuilder.Services.AddAuthorization(authorizationOptions =>
{
    ...
    authorizationOptions.AddPolicy(AuthorizationPolicies.SupportAgent, policyBuilder => policyBuilder
        .RequireAuthenticatedUser()
        .RequireRole(AuthorizationPolicies.SupportAgentRole));

    authorizationOptions.AddPolicy(AuthorizationPolicies.CustomerOrSupportAgent, policyBuilder => policyBuilder
        .RequireAuthenticatedUser()
        .RequireRole(
            AuthorizationPolicies.CustomerRole,
...
application.MapHub<SupportChatHub>(SupportChatHub.HubPath);
